...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        //zorgt dat je niet met storyboard werkt maar de window handmatig creeert in code. In dit geval een collectionview als rootviewcontroller is embed is als navigationcontroller
        ...
        statusBarView.backgroundColor = UIColor.rgb(red: 194, green: 31, blue: 31, alpha: 1)
